...
public class Searchflight_Test extends BaseClass{
	...
	public void SearchFlightOnewWayTrip() throws InterruptedException, IOException {
		//Create an object
		Searchflight onewaysearchflight=new Searchflight(driver);
...
*/
	...
	public void EnterPassengerDetails(WebDriver driver) throws InterruptedException {
		//Create an object
		Passengerdetails sppassengerDetails=new Passengerdetails(driver);
